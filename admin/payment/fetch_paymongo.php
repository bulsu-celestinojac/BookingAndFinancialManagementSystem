...
// 🚨 CRITICAL: REPLACE 'YOUR_PAYMONGO_SECRET_KEY' with your actual PayMongo Secret Key.
// WARNING: NEVER expose this key in client-side code (JavaScript).
// Using define() prevents accidental re-assignment or global exposure.
define('PAYMONGO_SECRET_KEY', "REDACTED"); // Your Secret Key here
